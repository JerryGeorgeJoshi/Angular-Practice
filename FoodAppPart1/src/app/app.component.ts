...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, BasicfooddataComponent, FooditemsummaryComponent, RatingPipe, FoodcategorylistComponent, FoodcategoryshowcaseComponent,NavbarComponent, MenuComponent, HomeComponent, ContactusComponent],
